<x-layout>
    ...
    @if($heroPhoto || $heroBlurb)
        <section class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 mb-10 shadow-sm overflow-hidden">
            {{-- Award Banner --}}
            @if($heroAwardText)
                <div class="bg-gray-200 dark:bg-gray-700 px-4 py-3">
                    <div class="flex items-center justify-center gap-2 text-base font-bold text-gray-800 dark:text-white tracking-wide">
