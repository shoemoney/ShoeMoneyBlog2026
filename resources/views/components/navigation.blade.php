    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between py-4 gap-4">
            ...
            <nav class="flex items-center gap-6 text-sm font-medium shrink-0">
                ...
                <a href="/about/"
                   class="text-gray-700 dark:text-slate-300 hover:text-brand-primary transition-colors {{ request()->is('about*') ? 'text-brand-primary' : '' }}">
                    About
                </a>
                <a href="/contact/"
                   class="text-gray-700 dark:text-slate-300 hover:text-brand-primary transition-colors {{ request()->is('contact*') ? 'text-brand-primary' : '' }}">
                    Contact
                </a>
