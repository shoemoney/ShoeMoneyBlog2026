...
Output: Migration for is_admin, updated User model, Gate::before in AppServiceProvider, login route, and protected admin route group.
</objective>
...
<task type="auto">
  <name>Task 2: Create login route and protected admin route group</name>
  <files>
    routes/web.php
    app/Http/Controllers/Auth/LoginController.php
    resources/views/auth/login.blade.php
...
4. Add admin route group (placeholder for now):
   ```php
